...
def commits_files_PMD_resolved_violations(commit_files_df, pmd_report_format, rulesets,total_possible_modified_lines, path_to_commits_data, path_to_results):
    ...
    for index,row in commit_files_df.iterrows():        
        ...
        if(len(possibly_Resolved_Violations_this_file) <= total_possible_modified_lines ):
